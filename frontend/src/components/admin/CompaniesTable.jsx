...
const CompaniesTable = () => {
    ...
    return (
        <div className="bg-white bg-opacity-80 backdrop-blur-md p-6 rounded-lg shadow-xl border border-gray-300">
            ...
            <Table className="min-w-full">
                <TableCaption className="text-center text-lg font-semibold mb-4">Recent Registered Companies</TableCaption>
                <TableHeader>
                    <TableRow className="bg-purple-500 text-white">
                        <TableHead className="py-3 px-4 text-black">Logo</TableHead>
                        <TableHead className="py-3 px-4 text-black">Name</TableHead>
                        <TableHead className="py-3 px-4 text-black">Date</TableHead>
                        <TableHead className="text-right py-3 px-4 text-black">Action</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
