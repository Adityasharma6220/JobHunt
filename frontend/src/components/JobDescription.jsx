    ...
    const applyJobHandler = async () => {
        try {
            ...
            if (res.data.success) {
                ...
                dispatch(setSingleJob(updatedSingleJob)); // Update global state
            }
        } catch (error) {
            console.error(error);
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Industry:<span className='pl-4 font-normal text-gray-800'>{singleJob?.industry}</span></h1>
                ...
                <h1 className='font-bold my-1'>Website Link:<span className='pl-4 font-normal text-gray-800'>{singleJob?.company.website}</span></h1>
                <h1 className='font-bold my-1'>Position:<span className='pl-4 font-normal text-gray-800'>{singleJob?.position} position</span></h1>
